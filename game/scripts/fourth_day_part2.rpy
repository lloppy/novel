label fourth_day_morning:
    ...
    # rewrite (на телефоне несколько банальных бесед, беседа “другая реальность” и сверху с акцентом сообщение от Карэн)

    "Ого, и чего это Карэн понадобилось от меня в нерабочее время?"

    # rewrite (сообщение: Может, компания и команда кажутся тебе очень серьезными и важными, или мои слова порой звучат грубо, но я думаю, что вечер в компании ребят из отдела поможет тебе лучше всех понимать и, возможно, откроет для тебя другую сторону нашей работы. В общем, я зову сегодня всех наших в кафе, отпразднуем твое возвращение в компанию, ну и просто пообщаемся. Присоединишься?)
